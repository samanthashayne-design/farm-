...
const sceneHints = {
  scene2: [
    { text: "plant new crops here", top: '83%', left: '34%' },
    { text: "check on crops you've already planted", top: '83%', left: '54%' },
    { text: "always brings you back to this home screen", top: '0%', left: '1%' },
    { text: "make it rain! helps crops grow gradually + independently", top: '94%', left: '1%' },
    { text: "make it day or night! also helps crops grow", top: '100%', left: '7.5%' },
  ],
  scene3: [
    { text: "tap a card to plant that crop in its matching plot", top: '27%', left: '76%' },
  ],
  scene5: [
    { text: "click to dig a spot for each of your seed!", top: '430px', left: '110px' },
    { text: "click to water your seed + watch it sprout", top: '520px', left: '110px' },
  ],
  scene4: [
    { text: "click to pick up the watering can, then hover over a plot + watch it grow!", top: '520px', left: '110px' },
    { text: "you can also use these to help your plants grow!", top: '100%%', left: '7.5%' },
  ],
  scene6: [
...
function drawScene4() {
  ...
  if (!seenHarvestHint && growth.some(g => g > 80)) {
    ...
    createHintBubble("select a completed plot, then dig to harvest it!", '430px', '110px');
  }
}
